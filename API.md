...
* **options** (<code>[GuTsLambdaOptions](#projen-test-gutslambdaoptions)</code>)  *No description*
  ...
  * **stack** (<code>string</code>)  *No description* 
  * **region** (<code>string</code>)  *No description* __*Optional*__
  * **runtime** (<code>string</code>)  *No description* __*Optional*__
...
**defaultReleaseBranch**🔹 | <code>string</code> | The name of the main release branch.
**name**🔹 | <code>string</code> | This is the name of your project.
**stack** | <code>string</code> | <span></span>
